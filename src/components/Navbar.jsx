    ...
    <header className="sticky top-0 z-50 bg-[#FDF3E2]/90 backdrop-blur-md border-b border-[#D9DCD5]">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 transition-transform hover:scale-105">
          <img src="/src/assets/1001GOUTS-LOGO-RVB.png" alt="1001 Goûts" className="h-10" />
        </Link>
        <nav className="hidden md:flex gap-8">
          <Link to="/bouchers" className="text-[#4F4D43] font-medium hover:text-[#558D4D] transition-colors">
            Pour les Bouchers
          </Link>
          <Link to="/itinerants" className="text-[#4F4D43] font-medium hover:text-[#558D4D] transition-colors">
            Pour les Itinérants
          </Link>
        </nav>
        <a 
