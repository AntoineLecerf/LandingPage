  ...
  return (
    <footer className="bg-[#19522A] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          <h4 className="font-display font-semibold text-lg mb-4 text-[#FDF3E2]">Solutions B2B</h4>
          <ul className="space-y-3 text-[#8A939B] text-sm">
        ...
        <div>
          <h4 className="font-display font-semibold text-lg mb-4 text-[#FDF3E2]">Ressources</h4>
          <ul className="space-y-3 text-[#8A939B] text-sm">
        ...
        <div>
          <h4 className="font-display font-semibold text-lg mb-4 text-[#FDF3E2]">Nous contacter</h4>
          <ul className="space-y-3 text-[#8A939B] text-sm">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-[#262B30] flex flex-col md:flex-row items-center justify-between text-xs text-[#667079]">
