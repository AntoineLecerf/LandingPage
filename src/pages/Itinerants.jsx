    ...
    <div className="w-full">
      ...
      <section className="relative overflow-hidden bg-[#FBFBF8] pt-20 pb-24 md:pt-32 md:pb-32">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="z-10 order-2 md:order-1">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#F9A81E]/10 text-[#F9A81E] font-mono text-xs font-bold tracking-widest uppercase mb-6">
              <span className="w-2 h-2 rounded-full bg-[#F9A81E]"></span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#inscription" className="bg-[#14181C] hover:bg-[#262B30] text-white px-8 py-4 rounded-full font-medium text-lg text-center transition-all shadow-md hover:shadow-lg flex items-center justify-center gap-2 group">
          ...
          <div className="relative z-10 flex justify-center order-1 md:order-2">
              ...
              <div className="absolute inset-0 bg-[#FDF3E2] p-4 pt-12">
                ...
                <div className="w-full h-48 bg-[#D9DCD5] rounded-2xl mb-4 relative overflow-hidden">
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <MapPin className="w-10 h-10 text-[#F9A81E] fill-current animate-bounce" />
                  </div>
                </div>
                
                <div className="bg-white p-4 rounded-xl border border-[#D9DCD5]">
                  <h3 className="font-display font-bold text-xl text-[#14181C]">Le Camion à Pizzas</h3>
            ...
            <div className="absolute top-10 left-10 w-64 h-64 bg-[#F9A81E]/20 rounded-full blur-3xl -z-10"></div>
            <div className="absolute bottom-10 right-10 w-64 h-64 bg-[#1A5F96]/20 rounded-full blur-3xl -z-10"></div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-[#D9DCD5] shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
              ...
              <h3 className="text-xl font-display font-bold text-[#14181C] mb-3">La Visibilité</h3>
            ...
            <div className="bg-white p-8 rounded-2xl border border-[#D9DCD5] shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
              ...
              <p className="text-[#667079] text-sm leading-relaxed">
                Les plateformes de livraison mangent la rentabilité de la vente à emporter. Nous sommes un outil de connexion, pas un intermédiaire. <strong className="text-[#14181C]">0% de commission.</strong>
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-[#D9DCD5] shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
              ...
              <h3 className="text-xl font-display font-bold text-[#14181C] mb-3">La Fidélisation</h3>
              <p className="text-[#667079] text-sm leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="bg-[#14181C] p-10 rounded-[2rem] relative overflow-hidden text-white order-2 md:order-1">
              <div className="absolute top-0 right-0 w-64 h-64 bg-[#F9A81E]/20 rounded-full blur-3xl"></div>
              <h3 className="text-2xl font-display font-bold mb-4 relative z-10">Conçu pour l'action.</h3>
              ...
              <ul className="space-y-6">
                <li className="flex gap-4">
                  <div className="flex-shrink-0 mt-1">
                    <CheckCircle2 className="w-6 h-6 text-[#F9A81E]" />
                  </div>
                  <div>
                    <h4 className="text-lg font-bold text-[#14181C] mb-1">Mise à jour en 1 clic</h4>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#14181C] mb-1">Fiche Commerce Express</h4>
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#14181C] mb-1">Label "1001 Engagés"</h4>
      ...
      <section id="inscription" className="py-24 bg-[#FDF3E2] relative overflow-hidden">
        <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl font-display font-bold mb-6 text-[#14181C]">Rejoignez le réseau local.</h2>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-[#D9DCD5] max-w-md mx-auto">
            <h3 className="text-xl font-bold text-[#14181C] mb-6">Créer ma fiche Itinérant</h3>
            <form className="space-y-4 text-left">
              <div>
                <label className="block text-sm font-medium text-[#4F4D43] mb-1">Nom (Food Truck, Stand...)</label>
                <input type="text" className="w-full px-4 py-3 rounded-lg border border-[#D9DCD5] focus:outline-none focus:ring-2 focus:ring-[#F9A81E]/50 focus:border-[#F9A81E]" placeholder="Ex: La Belle Époque Foodtruck" />
              </div>
              <div>
                <label className="block text-sm font-medium text-[#4F4D43] mb-1">Email professionnel</label>
                <input type="email" className="w-full px-4 py-3 rounded-lg border border-[#D9DCD5] focus:outline-none focus:ring-2 focus:ring-[#F9A81E]/50 focus:border-[#F9A81E]" placeholder="contact@itinerant.fr" />
              </div>
              <div>
                <label className="block text-sm font-medium text-[#4F4D43] mb-1">Spécialité</label>
                <select className="w-full px-4 py-3 rounded-lg border border-[#D9DCD5] focus:outline-none focus:ring-2 focus:ring-[#F9A81E]/50 focus:border-[#F9A81E]">
              ...
              <button type="button" className="w-full bg-[#F9A81E] hover:bg-[#D2542B] text-white font-medium py-3 rounded-lg transition-colors mt-4">
