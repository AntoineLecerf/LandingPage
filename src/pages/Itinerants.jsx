        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="z-10 order-2 md:order-1">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-display leading-[1.1] text-[#19522A] mb-6 tracking-tight">
              ...
              <span className="text-[#19522A] font-accent font-normal tracking-normal text-6xl md:text-7xl lg:text-8xl block mt-2">Ils le voient en direct.</span>
            </h1>
            ...
            <div className="relative w-full max-w-sm aspect-[9/19] bg-white rounded-[3rem] border-8 border-[#19522A] shadow-2xl overflow-hidden flex items-center justify-center">
              ...
              <div className="absolute inset-0 bg-[#FDF3E2] p-4 pt-12">
                ...
                <div className="bg-white p-4 rounded-xl border border-[#D9DCD5]">
                  <h3 className="font-accent text-xl text-[#FF859D]">Le Camion à Pizzas</h3>
